...
const PhoneShop = () => {
  ...
  const wearablesCategory = productData.find(
    (category) =>
      category.category_name.toLowerCase() === 'wearables'.toLowerCase()
  );

  if (!wearablesCategory || wearablesCategory.products.length === 0) {
    ...
    <div>
      ...
      <div className="phone-shop">
        ...
        <div className="category-container">
          ...
          <div key={wearablesCategory.category_name} className="category">
            <h2>{wearablesCategory.category_name}</h2>
            <p>{wearablesCategory.category_description}</p>
            <div className="phone-list">
              {/* Iterate over products in the 'Televisions' category */}
              {wearablesCategory.products.map((product) => (
